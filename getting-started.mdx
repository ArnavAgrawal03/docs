...
<CardGroup cols="2">
  <Card title="Configure Morphik" icon="gear" href="/configuration">
    Configure Morphik using the `databridge.toml` file.
  </Card>
  <Card title="API" icon="code" href="/api-reference/ingest-text">
  ...
  <Card title="Morphik UI and CLI" icon="react" href="/web-interface/introduction">
