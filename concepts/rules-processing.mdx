---
title: 'Rules'
description: 'An overview of rules based ingestion in DataBridge'
---
...
The LLM for rules processing is configured in your `databridge.toml` file using the registered models approach:
