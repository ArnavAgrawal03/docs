...
- What is the difference between keyword and vector search?
- How can I limit search to a specific document category?
- When should I use `query` instead of `retrieve_docs`?